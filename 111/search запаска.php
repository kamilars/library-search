...
<?php/*	<form name="search_by_parameters" action="search.php" method="post">
		<fieldset>
	...
	<form name="search_by_keywords"  action="search.php" method="post">
		<fieldset>
...
if (isset($_POST['search_by_keywords'])) {
	...
	for ($n=0; $n<count($results_keywords); $n++) 
		...
		<input type="submit" name="reserve_book_btn" value="Заказать">
		</form> </td>';
		echo "</tr>";	
			}
		echo '</table>';	
...
Не нашли, что хотели?
<a href="reserve_book_if_not_found.php">Перейти к заказу</a>
</div>
 </body>
</html>